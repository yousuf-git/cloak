...
export const WHY_MATRIX = {
  ...
  rows: [
    ...
    { feature: "Role-based access control for teams", marks: ["no", "yes", "no"] },
    { feature: "Per-organization audit trail", marks: ["no", "yes", "no"] },
    { feature: "Secure team sharing without plaintext on a server", marks: ["no", "no", "no"] },
